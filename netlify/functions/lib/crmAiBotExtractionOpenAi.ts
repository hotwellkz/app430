...
Поле city: только если КЛИЕНТ (user) явно назвал населённый пункт Казахстана или своё местоположение — в т.ч. внутри фраз («Я из Алматы», «мы в Астане», «участок в Караганде», «строить будем в Шымкенте»). Не подставляй город из ответов бота/менеджера, из шаблонов, ссылок и рекламы. Если клиент назвал несколько разных городов без ясного приоритета — city: null. Если уверен в одном городе из реплик клиента — кратко: «Алматы», «Астана», «Караганда» и т.п.
