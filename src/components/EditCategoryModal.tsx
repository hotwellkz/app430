    ...
    try {
      ...
      if (title !== category.title) {
        const [fromQuery, toQuery] = [
          query(collection(db, 'transactions'), where('companyId', '==', companyId), where('fromUser', '==', category.title)),
          query(collection(db, 'transactions'), where('companyId', '==', companyId), where('toUser', '==', category.title))
        ];
