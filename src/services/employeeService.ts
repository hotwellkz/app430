...
export const createEmployee = async (formData: EmployeeFormData, companyId: string): Promise<string> => {
  try {
...
export const updateEmployee = async (employeeId: string, formData: EmployeeFormData, companyId: string): Promise<void> => {
  try {
    const batch = writeBatch(db);
...
export const deleteEmployeeWithHistory = async (employee: Employee, companyId: string): Promise<void> => {
  try {
    const batch = writeBatch(db);
...
export const deleteEmployeeOnly = async (employee: Employee, companyId: string): Promise<void> => {
  try {
    const batch = writeBatch(db);
