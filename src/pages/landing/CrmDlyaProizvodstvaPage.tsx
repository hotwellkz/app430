...
const TITLE =
  'CRM для производства — заявки, клиенты, сделки и контроль отдела продаж | 2wix';
const DESCRIPTION =
  'CRM для производственной компании 2wix: заявки, клиентская база, переписка, сделки по этапам, контроль менеджеров и аналитика в одной системе. Универсальная CRM, которая хорошо подходит для производственного бизнеса.';

const PROBLEMS = [
  {
    title: 'Заявки и запросы клиентов приходят из разных каналов',
    text: 'Обращения в WhatsApp, на сайте, по почте, по телефону — размазаны по менеджерам. CRM для заявок на производстве собирает всё в одном месте.',
  },
  {
    title: 'Менеджеры ведут клиентов не по единому процессу',
    text: 'Каждый по-своему: кто в таблице, кто в чатах. Нет единой системы учёта для производства — трудно контролировать отдел продаж производственной компании.',
  },
  {
    title: 'Информация по клиентам и заказам разрознена',
    text: 'Переписка в одном месте, договорённости в другом, расчёты в третьем. Нет карточки клиента с полной историей. Система учёта для производства решает это.',
  },
  {
    title: 'Сложно понимать, на каком этапе клиент или заказ',
    text: 'Неясно, кто на стадии запроса, кто ждёт КП, кто в согласовании. Нет воронки и этапов — руководитель не видит картину по продажам.',
  },
  {
    title: 'Руководитель не видит общую картину по продажам и команде',
    text: 'Сколько заявок пришло, сколько клиентов в работе, кто из менеджеров что ведёт — на словах. Нет прозрачности по отделу продаж производственной компании.',
  },
  {
    title: 'Переписка, договорённости и расчёты теряются',
    text: 'Часть в мессенджерах, часть в почте. При смене менеджера контекст теряется. Программа для производственной компании с историей в карточке сохраняет всё.',
  },
  {
    title: 'Сложно передавать клиента между сотрудниками без потери контекста',
    text: 'Клиента передали другому менеджеру — требования и договорённости остались у прежнего. CRM для клиентов производства хранит всю историю в карточке.',
  },
];
...
const WHAT_2WIX_GIVES = [
  {
    ...
    text: 'Заявки из WhatsApp, сайта, почты, звонков — в одной CRM. CRM для заявок на производстве без потери обращений.',
  },
  {
    icon: Users,
    title: 'Клиентская база',
    text: 'Единая база клиентов производственной компании. Контакты, история, ответственный менеджер — в одной системе.',
  },
  {
    icon: FileText,
    title: 'Карточка клиента',
    text: 'Всё по клиенту в одном месте: контакты, переписка, комментарии, сделки. Удобно для отдела продаж производственной компании.',
  },
  {
    icon: MessageSquare,
  ...
  },
  {
    ...
    text: 'Воронка сделок: от первого контакта до договора. Видно, на каком этапе каждый клиент. CRM для продаж на производстве.',
  },
  {
    icon: UserCheck,
    title: 'Менеджеры и распределение ответственности',
    text: 'Назначение ответственного по клиенту и заявке. Контроль нагрузки. Система для производственной компании с прозрачностью по команде.',
  },
  {
    icon: BarChart3,
  ...
  },
  {
    ...
    text: 'Договорённости, требования клиента, детали заказа — в карточке. История не теряется при смене менеджера.',
  },
  {
    icon: Shield,
    title: 'Роли и права доступа',
    text: 'Руководитель, менеджер, сотрудник — разные права. CRM для производственной компании с разграничением доступа к разделам.',
  },
  {
    icon: Eye,
...
const FLOW_STEPS = [
  ...
  'Ведётся переписка, согласование, этапы сделки',
...
const WHAT_LEADER_SEES = [
  {
    ...
    text: 'Входящие по каналам и по периодам. Руководитель производственной компании видит поток обращений.',
  },
  {
    icon: Users,
    title: 'Сколько клиентов в работе',
    text: 'Сколько клиентов на каждом этапе. CRM для отдела продаж производственной компании с наглядной картиной.',
  },
  {
    icon: GitBranch,
  ...
  },
  {
    ...
    text: 'Сводная картина: заявки, клиенты, сделки, менеджеры. Программа для производственной компании с прозрачностью.',
  },
  {
    icon: BarChart3,
    title: 'Где есть просадки и узкие места',
    text: 'Где клиент ждёт ответа, где задержки. Аналитика для решений по процессам.',
  },
];
...
const WHY_FOR_PRODUCTION = [
  {
    icon: MessageCircle,
    title: 'Много коммуникации до сделки',
    text: 'Запросы, уточнения, согласование условий. CRM для производства хранит всю переписку и историю в карточке клиента.',
  },
  {
    icon: FileText,
    title: 'Важно не терять требования клиента',
    text: 'Спецификации, объёмы, сроки — в комментариях и переписке. Система учёта для производства сохраняет контекст.',
  },
  {
    icon: StickyNote,
    title: 'Важно хранить историю договорённостей',
    text: 'Что согласовали, какие условия — в карточке. При передаче клиента контекст не теряется.',
  },
  {
    icon: GitBranch,
    title: 'Важно видеть этапы и статус',
    text: 'На каком этапе клиент, кто ведёт. Руководитель видит воронку и нагрузку на отдел продаж производственной компании.',
  },
  {
    icon: FileText,
    title: 'Важно быстро находить контекст по клиенту',
    text: 'Один клиент — одна карточка с полной историей. CRM для производственного бизнеса без поиска по чатам и таблицам.',
  },
  {
    icon: Users,
    title: 'Важно работать командой в одной системе',
...
const FAQ_ITEMS = [
  {
    q: 'Подходит ли 2wix для производственной компании?',
    a: 'Да. 2wix — универсальная CRM для бизнеса, которая хорошо подходит для производственных компаний: заявки из разных каналов, клиентская база, карточка клиента с перепиской и комментариями, сделки по этапам, контроль менеджеров и аналитика в одной системе. Многие производственные компании используют 2wix для отдела продаж и работы с клиентами.',
  },
  {
    q: 'Можно ли вести заявки и клиентов в одной системе?',
    a: 'Да. В 2wix ведётся учёт заявок и клиентов: каждому клиенту соответствует карточка с контактами, перепиской, сделками и комментариями. Сделки можно вести по этапам. CRM для производственной компании с единой базой и воронкой.',
  },
  {
    q: 'Есть ли WhatsApp и история переписки?',
    a: 'Да. Переписка из WhatsApp попадает в CRM и привязывается к карточке клиента. Менеджеры работают в едином интерфейсе — заявки из мессенджера не теряются. CRM для заявок на производстве с WhatsApp в одном окне.',
  },
  {
    q: 'Можно ли контролировать менеджеров и этапы сделок?',
    a: 'Да. Руководитель видит, кто какой клиент ведёт, сколько заявок у каждого, где непрочитанные сообщения и где сделки зависли. Этапы воронки и активность менеджеров — в одной системе. Контроль отдела продаж производственной компании без ручного сбора отчётов.',
  },
  {
    q: 'Подходит ли 2wix для небольших производственных компаний?',
    a: 'Да. CRM для производства полезна уже с небольшим отделом продаж: заявки не теряются, клиенты и переписка в одном месте, этапы сделок видны. Система масштабируется при росте.',
  },
  {
    q: 'Можно ли использовать систему не только для производства?',
    a: 'Да. 2wix — универсальная CRM: подходит для отдела продаж, работы с клиентами и заявками в разных отраслях. Производственная компания — один из сильных кейсов: много коммуникации, важна история и этапы. Но ту же систему используют и строительные, и сервисные компании, и продажи услуг.',
  },
  {
    q: 'Есть ли аналитика по обращениям и продажам?',
    a: 'Да. В 2wix есть аналитика: сколько заявок пришло и обработано, по каким каналам, как движутся сделки по этапам, нагрузка по менеджерам. Руководитель производственной компании видит картину по отделу продаж в одной CRM.',
  },
];
...
export const CrmDlyaProizvodstvaPage: React.FC = () => {
  const navigate = useNavigate();

  return (
    <SEOPageLayout title={TITLE} description={DESCRIPTION} path="/crm-dlya-proizvodstva">
      {/* Hero */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-sf-text-primary tracking-tight leading-tight">
                CRM для производства: заявки, клиенты, сделки и контроль процессов
              </h1>
              <p className="mt-6 text-lg md:text-xl text-sf-text-secondary max-w-xl leading-relaxed">
                2wix помогает производственным компаниям собирать заявки, вести клиентов, работать с WhatsApp, контролировать менеджеров, вести сделки и видеть аналитику в одной системе.
              </p>
      ...
      {/* Какие проблемы решает CRM в производственной компании */}
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-sf-text-secondary text-center max-w-2xl mx-auto mb-14">
            Без системы заявки разрознены, менеджеры ведут клиентов кто как хочет, а руководитель не видит картины.
          </p>
      ...
      {/* Что даёт 2wix производственной компании */}
      <section className="py-16 md:py-24 bg-sf-backgroundSection/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-sf-text-secondary text-center max-w-2xl mx-auto mb-14">
            Заявки, клиенты, переписка, сделки по этапам и контроль отдела продаж — CRM для производственного бизнеса в одной системе.
          </p>
      ...
      {/* Как это работает в производственной компании */}
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-sf-text-secondary text-center mb-14">
            От заявки до контроля — всё в одной CRM для производства.
          </p>
      ...
      <section className="py-16 md:py-24 bg-sf-backgroundSection/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-sf-text-secondary text-center max-w-2xl mx-auto mb-14">
            Прозрачность для собственника и руководителя производственной компании: заявки, клиенты, сделки, менеджеры.
          </p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-sf-text-secondary text-center max-w-2xl mx-auto mb-14">
            2wix — единая CRM для производственного бизнеса: не набор разрозненных чатов и таблиц, а одна система.
          </p>
      ...
      {/* Почему это особенно полезно для производства */}
      <section className="py-16 md:py-24 bg-sf-backgroundSection/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-sf-text-primary text-center mb-4">
            Почему это особенно полезно для производственной компании
          </h2>
          <p className="text-lg text-sf-text-secondary text-center max-w-2xl mx-auto mb-14">
            Много коммуникации, требования клиента и договорённости — CRM для производства сохраняет контекст и этапы.
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {WHY_FOR_PRODUCTION.map(({ icon: Icon, title, text }) => (
              <div
                key={title}
                className="rounded-sfCard border border-sf-border bg-sf-surface p-6 shadow-sm"
              >
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-sf-text-secondary text-center mb-14">
            CRM для производственной компании с перепиской, этапами сделок, менеджерами и отчётами в одной системе.
          </p>
      ...
      <section className="py-16 md:py-24 bg-sf-backgroundSection/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-sf-text-secondary text-center max-w-2xl mx-auto mb-14">
            Ручной подход в производственной компании против CRM в одной системе.
          </p>
      ...
      <section className="py-20 md:py-28 bg-sf-primary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-sf-text-inverse mb-4">
            Запустите CRM для производственной компании, где заявки, клиенты и продажи под контролем
          </h2>
          <p className="text-lg text-white/95 mb-10">
            Универсальная CRM, которая хорошо подходит для производственного бизнеса. <Link to="/ceny" className="text-white/95 underline hover:text-white">Тарифы</Link> и бесплатный старт — на странице цен.
          </p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-sf-text-primary text-center mb-4">
            Вопросы о CRM для производственной компании
          </h2>
          <p className="text-sf-text-secondary text-center mb-14">
            Частые вопросы о 2wix для производственного бизнеса и отдела продаж.
          </p>
